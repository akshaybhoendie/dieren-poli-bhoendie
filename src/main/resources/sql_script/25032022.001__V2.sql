...
-- Dumping data for table dieren_poli_bhoendie.dienst: ~0 rows (approximately)
...
-- Dumping data for table dieren_poli_bhoendie.diensttype: ~0 rows (approximately)
...
-- Dumping data for table dieren_poli_bhoendie.dier: ~0 rows (approximately)
...
-- Dumping data for table dieren_poli_bhoendie.gebruiker: ~0 rows (approximately)
...
-- Dumping data for table dieren_poli_bhoendie.lidmaatschap: ~0 rows (approximately)
